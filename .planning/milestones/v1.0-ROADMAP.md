...
- [x] 04-02-PLAN.md — Dashboard page rewrite with donut chart, bar chart, recent transactions preview, category click-to-filter
- [x] 04-03-PLAN.md — Transactions page with TanStack Table, search, category filter, sort, pagination, mobile cards, sidebar nav enablement
**UI hint**: yes
